...
<head>
    ...
    <title>Transports Plessier - Service - Logistique</title>
</head>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <h1 class="font-weight-bold text-center mb-5"><i class="fas fa-truck-loading"></i> Logistique <i class="fas fa-truck-loading"></i></h1>
